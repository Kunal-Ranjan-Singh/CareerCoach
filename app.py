...
embeddings = OpenAIEmbeddings(model="text-embedding-ada-002", api_key="YOUR_KEY_HERE")
...
llm = ChatOpenAI(
    ...
    api_key="YOUR_KEY_HERE",  # if you prefer to pass api key in directly instaed of using env vars
